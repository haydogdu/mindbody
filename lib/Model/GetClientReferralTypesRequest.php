 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetClientReferralTypesRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $include_inactive When `true`, filters the results to include subtypes and inactive referral types.<br />  When `false`, includes no subtypes and only active types.
     *
     * @return $this
     */
