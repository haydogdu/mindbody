...
class GetResourcesRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int[] $session_type_ids List of session type IDs.<br />  Default: **all**
     *
     * @return $this
     */
     ...
     * Sets location_id
     *
     * @param int $location_id The location of the resource. This parameter is ignored if `EndDateTime` or `LocationID` is not set.<br />  Default: **all**
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $start_date_time The time the resource starts. This parameter is ignored if `EndDateTime` or `LocationID` is not set.
     *
     * @return $this
     */
     ...
     * Sets end_date_time
     *
     * @param \DateTime $end_date_time The time the resource ends. This parameter is ignored if `EndDateTime` or `LocationID` is not set.
     *
     * @return $this
     */
