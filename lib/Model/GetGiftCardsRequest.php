 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetGiftCardsRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets location_id
     *
     * @param int $location_id When included, returns gift cards that are sold at the provided location ID.
     *
     * @return $this
     */
     ...
     * Sets sold_online
     *
     * @param bool $sold_online When `true`, only returns gift cards that are sold online.<br />  Default: **false**
     *
     * @return $this
     */
