 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetCrossRegionalClientAssociationsRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets client_id
     *
     * @param string $client_id Looks up the cross regional associations by the client’s ID. Either `ClientId` or `Email` must be provided. If both are provided, the `ClientId` is used by default.
     *
     * @return $this
     */
