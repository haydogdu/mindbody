 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetProgramsRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets schedule_type
     *
     * @param string $schedule_type A schedule type used to filter the returned results.
     *
     * @return $this
     */
     ...
     * Sets online_only
     *
     * @param bool $online_only If `true`, filters results to show only those programs that are shown online.<br />  If `false`, all programs are returned.<br />  Default: **false**
     *
     * @return $this
     */
