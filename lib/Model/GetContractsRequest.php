 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetContractsRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['contract_ids'] = isset($data['contract_ids']) ? $data['contract_ids'] : null;
     ...
     * Sets contract_ids
     *
     * @param int[] $contract_ids When included, the response only contains details about the specified contract IDs.
     *
     * @return $this
     */
     ...
     * Sets sold_online
     *
     * @param bool $sold_online When `true`, the response only contains details about contracts and AutoPay options that can be sold online.<br />  When `false`, only contracts that are not intended to be sold online are returned.<br />  Default: **all contracts**
     *
     * @return $this
     */
     ...
     * Sets location_id
     *
     * @param int $location_id The ID of the location that has the requested contracts and AutoPay options.
     *
     * @return $this
     */
     ...
     * Sets consumer_id
     *
     * @param int $consumer_id The ID of the client.
     *
     * @return $this
     */
