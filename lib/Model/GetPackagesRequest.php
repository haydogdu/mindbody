 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetPackagesRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['package_ids'] = isset($data['package_ids']) ? $data['package_ids'] : null;
     ...
     * Sets package_ids
     *
     * @param int[] $package_ids A list of the packages IDs to filter by.
     *
     * @return $this
     */
     ...
     * Sets sell_online
     *
     * @param bool $sell_online When `true`, only returns products that can be sold online.<br />  When `false`, all products are returned.<br />  Default: **false**
     *
     * @return $this
     */
