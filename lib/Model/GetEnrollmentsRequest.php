 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetEnrollmentsRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int[] $class_schedule_ids A list of the requested class schedule IDs. If omitted, all class schedule IDs return.
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date The end of the date range. The response returns any active enrollments that occur on or before this day.<br />  Default: **StartDate**
     *
     * @return $this
     */
     ...
     * Sets location_ids
     *
     * @param int[] $location_ids List of the IDs for the requested locations. If omitted, all location IDs return.
     *
     * @return $this
     */
     ...
     * Sets program_ids
     *
     * @param int[] $program_ids List of the IDs for the requested programs. If omitted, all program IDs return.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $session_type_ids List of the IDs for the requested session types. If omitted, all session types IDs return.
     *
     * @return $this
     */
     ...
     * Sets staff_ids
     *
     * @param int[] $staff_ids List of the IDs for the requested staff IDs. If omitted, all staff IDs return.
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date The start of the date range. The response returns any active enrollments that occur on or after this day.<br />  Default: **today’s date**
     *
     * @return $this
     */
