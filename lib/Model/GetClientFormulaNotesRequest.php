 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetClientFormulaNotesRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets client_id
     *
     * @param string $client_id The client ID of the client whose formula notes are being requested.
     *
     * @return $this
     */
     ...
     * Sets appointment_id
     *
     * @param int $appointment_id The appointment ID of the appointment that the formula notes are related to.
     *
     * @return $this
     */
